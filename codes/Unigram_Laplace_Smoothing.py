...
class UnigramPerplexity:
    ...
    def __init__(self):
        self.unigramCounts=pd.read_csv(os.getcwd()+"\\counts\\unigram_counts.csv")
        ...
        self.V = len(self.unigramCounts.index)  # vocabulary size for smoothing. We have taken total unique unigrams as vocabulary
        ...
        self.unigramCounts.to_csv("results\\unigramCounts.csv",index=False)
    ...
    def findPerplexity(self):
        ...
        df.to_csv("results\\unigramPerplexity.csv")
